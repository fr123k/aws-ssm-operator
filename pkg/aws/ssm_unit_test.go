...
func TestSSMParameterValueToSecretByName(t *testing.T) {
	StartTestServer(t)
	responses.Push(SSMParameter("name", "aws-docs-example-parameter-value"))
	ssm := NewSSMClient(nil)
...
func TestFetchParametersStoreValues(t *testing.T) {
	StartTestServer(t)
	responses.Push(SSMParameter("name", "aws-docs-example-parameter-value"))
	responses.Push(SSMParameter("name2", "an other parameter"))
...
func TestSSMParameterValueToSecretByPath(t *testing.T) {
	StartTestServer(t)
	responses.Push(SSMParameters(map[string]string{"/path/param1": "aws-docs-example-parameter-value", "/path/param2": "value2"}))
	ssm := NewSSMClient(nil)
